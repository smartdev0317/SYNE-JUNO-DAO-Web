...
import './Toast.scss';
import START_ICON from '@client/assets/transaction_start_icon.svg';
import SUCCESS_ICON from '@client/assets/transaction_success_icon.svg';
import REJECT_ICON from '@client/assets/transaction_reject_icon.svg';
